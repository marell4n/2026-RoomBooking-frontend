        ...
        try {
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 animate-fade-in-up">
                ...
                <div class="md:col-span-2 bg-user text-white p-6 rounded-2xl shadow-lg flex justify-between items-center relative overflow-hidden">
                    <div class="absolute right-0 top-0 w-32 h-32 bg-main-white opacity-10 rounded-bl-full -mr-4 -mt-4"></div>
                    <div class="relative z-10">
                        ...
                        <a href="booking-form.html" class="inline-block bg-main-white text-user font-bold py-2.5 px-6 rounded-xl shadow-sm hover:bg-gray-100 hover:shadow-md transition">
                            + Booking Sekarang
                        </a>
                ...
                <a href="rooms.html" class="bg-main-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-center hover:shadow-md transition group cursor-pointer relative overflow-hidden">
